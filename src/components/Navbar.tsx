...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur-xl border-b transition-all duration-300 bg-slate-900/90 border-slate-800/80 shadow-md" data-testid="app-navbar">
      <div className="max-w-6xl mx-auto px-4 py-2.5 space-y-2">
        ...
        {/* ── Secondary Sub-Navbar Tabs (All Tools Indexed for Direct Desktop Access) ── */}
        <div className="flex items-center gap-1 overflow-x-auto pb-0.5 scrollbar-none pt-1 border-t border-slate-800/60">
          <button
            onClick={() => setActiveTab('dashboard')}
